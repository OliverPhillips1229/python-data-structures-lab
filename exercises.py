...
#
# Assign to a variable named foods_with_an_a the result of 
# list comprehension that filters the foods tuple to only 
# include food strings that contain the letter 'a'.
